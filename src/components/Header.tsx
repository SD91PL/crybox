...
export default function Header() {
	return (
		<section
			...
			/>
			<div className='absolute bottom-2 xl:bottom-10 h-1/3 w-full flex flex-col justify-center items-center'>
				<a href='#mapping' className='min-w-[max(160px,14%)] min-h-[68px]'>
					<Image
